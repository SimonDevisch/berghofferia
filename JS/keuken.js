  ...
  setKeuken() {
    ...
    kitchenScreen.innerHTML = `
        ...
        <div class="pannen">
            ...
            <img id="panVuur1" class="vuurPan hidden" src="./images/bovenaanzicht_pan.png" alt="bovenview pan">
            <img id="panVuur2" class="vuurPan hidden" src="./images/bovenaanzicht_pan.png" alt="bovenview pan">
        </div>
